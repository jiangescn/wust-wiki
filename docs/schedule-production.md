...
教学周必须手动选择，默认显示全部课程。当前没有经过核验的学期起始日，不将某一周默认称作“本周”。周数范围来自已读取课程，不宣称是校历总周数。用户提供的两校区时间表只覆盖第 1–10 节；第 11 节以后仅显示节次，不推算时间。作息来源完整抄录见 [渲染调研](./schedule-rendering-research.md)。校区切换不推断课程所在校区。
